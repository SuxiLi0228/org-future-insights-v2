import type { NewsItem, ArxivPaper, JobPosting } from '@/types';
...
export const generatedNews: NewsItem[] = [
  ...
  {
    "id": "news-ai-1785666824000",
    "title": " 曾开创互动影视赛道，付费用户超千万，他认为AI开始解决影游的根本问题 ",
    "link": "https://www.huxiu.com/article/4880062.html?f=rss",
    "summary": "本文来自微信公众号： 游戏茶馆 ，作者：茶馆小二儿 导语 一条空前热闹的赛道，和等待被AI攻破的壁垒 鹍鹏是那类把愿景刻进自己骨子里的创始人。 十年前，他玩到了《暴雨》《超凡双生》、Telltale的《行尸走肉》等游戏，第一次被交互叙事击中，随后创办了互影科技——“互影”，后来被他们定义为互动影视。在最近和茶馆君聊天的时候，他向我推荐了Netflix前阵子上线的恐怖互动影视产品《Unhinged》，其中一个桥段是，主角能直接把电话打到观众的手机上。他在聊起这些瞬间时依然会不自觉地语速加快，流露出与当年无二的激动。 前阵子，《盛世天下》销量500万的消息让互动影游品类再次进入大众视野，字节和腾讯等大厂开始集体押注这个赛道，Dataeye研究院预测，这个品类正在爆发期，相较前年或成长超90%。 数据来源：Dataeye研究院 鹍鹏非常欣慰：“大家终于看到交互叙事的魅力和价值，更多优秀的创作者和创业者才会进来，这个是我想看到的”。 在过去十年里，他们定义过国产互动品类的几个关键拐点。 互影在2019年上线的《古董局中局之佛头起源》，被认为是国内互动剧产品的开山之作；他们在2022年联动B站，拉上逍遥散人、C酱等知名Up主和三百多万名用户一起参与《超级狸谱表决》，让观众们通过上百万条弹幕影响一场大逃杀的走向；最为游戏圈所熟知的是互动影游《飞越13号房》，销量破了百万；互影旗下的产品，全球付",
  ...
  {
    "id": "news-ai-1785666488000",
    "title": " AI时代，效率正在消灭学徒期 ",
    "link": "https://www.huxiu.com/article/4880060.html?f=rss",
    "summary": "本文来自微信公众号： HavenlonLabs ，作者：Havenlon&nbsp;Labs 当AI接管初级工作，我们可能也在拆掉人类成为专家的阶梯 过去，人们担心机器抢走流水线上的岗位。今天，机器开始接管另一类任务：写第一版文案、整理会议纪要、检索资料、制作报表、修改代码、起草合同——那些需要一定知识、却不需要太多经验的工作。 在成本表上，这类\"初级工作\"重复、琐碎、耗时，而且容易被衡量。既然AI能更快、更便宜地完成，压缩初级岗位似乎顺理成章。 问题也恰恰出在这里。我们习惯把初级工作理解为一种低效率的生产活动，却很少意识到，它同时是一套人才培养机制。 一个年轻人不是先成为专家再开始工作。恰恰相反，他是在一次次并不高明的工作中，逐渐成为专家。 企业正在用今天的效率，透支明天的专家。 一、初级工作从来不只是工作 律师事务所里，年轻律师从检索案例、整理证据、修改合同开始。软件公司里，初级工程师从修复小问题、阅读旧代码、处理测试失败开始。媒体、医院、会计师事务所和金融机构，都存在相似的成长路径。 这些任务常常显得机械烦琐，但它们的价值从来不只在产出。 查过一百份资料，才逐渐知道哪一类来源值得信任；改过几十次代码，才理解一个微小改动为什么可能影响整个系统；处理过大量普通案例，才可能在异常出现时意识到\"这次不太一样\"。 专业能力不是一本知识手册。它包含大量难以明确写出的东西：对异常的敏感、对",
    "publishedAt": "2026-08-02",
    "source": "虎嗅",
    "tags": [
      "china",
  ...
  {
    "id": "news--1785644606000",
    "title": "重庆上市公司价值重估：汽车与环保抬升上限，医药与传统产业分化加剧",
    "link": "https://www.tmtpost.com/8088415.html",
    "summary": "从本次重庆66家样本看，综合ESG-V评级呈现出“头部特色鲜明、中间层占主导、尾部压力集中”的结构。AAA企业1家，AA企业3家，A企业8家，A及以上企业合计12家，占比约18.2%；BBB、BB、B三级企业共41家，占比约62.1%；CCC及以下企业13家，占比约19.7%。",
    "publishedAt": "2026-08-02",
    "source": "钛媒体",
    "tags": [
      "china",
  ...
  {
    "id": "news-ai-1785665182000",
    "title": " 从吴启华到王祖贤，AI肖像授权这门生意没那么简单 ",
    "link": "https://www.huxiu.com/article/4880054.html?f=rss",
    "summary": "本文来自微信公众号： 骨朵网络影视 ，作者：GuDuo骨朵编辑部 “倩影”归来。 息影22年的王祖贤，将20岁至30岁巅峰时期的肖像使用权授权给网易游戏《天下》，以AI数字分身的形式重返荧幕。名为《倩影》的广告短片中，聂小倩、白素贞等经典角色重获新生，以角色口吻打破第四面墙与玩家互动。短片最后，王祖贤化身为九尾白狐，缓缓道出那句“红尘走过，我还是我”，正应和了观众对港片黄金时代的集体怀旧。 截至最新，该短片在B站上的播放量已超298万。 演员们曾因职业骄傲与身份认同，而对AI替身持排斥态度。但在AI短剧冲击整个真人影视行业的当下，排斥态度也开始松动。 行业里首先拥抱“肖像授权AI”的是老牌明星，除王祖贤之外，成龙、游本昌、吴启华此前也通过不同方式用AI制作数字人替身，用于电影、微短剧等作品。而年轻演员们则在谨慎中保持观望态度。 这门生意并非只是简单的演员“卖脸”、出品方“卖情怀”。当AI替身成为演员的第二职业身份，肖像权不再是简单的个人权利，更成为一种数字资产、商业谈判筹码。谁能借用法律武器维护自己的权益，谁就能在即将到来的“AI替身”热潮中掌握主动权。 情怀牌的新打法 港影没落、港星已老是80后、90后两代人的情结和惆怅。 情怀亦是一种变现方式，还未退圈的老港星们在综艺、直播、拼盘电影、网络短剧中继续活跃；只有少数几个能够遇上好剧本，继续以演员身份发光发热。观众们乐于看到老牌明星",
    "publishedAt": "2026-08-02",
    "source": "虎嗅",
    "tags": [
      "china",
  ...
  {
    "id": "news-a-1785644523000",
    "title": "A股规模实力百强榜：谁构筑了资本市场的经营基本盘？",
    "link": "https://www.tmtpost.com/8088411.html",
    "summary": "从榜单结果看，本次规模实力排名前100的上市公司全部获得AAA评级。其中，最高得分为第1名工商银行的99.583分，最低得分为第100名药明康德的94.507分。工商银行、建设银行、农业银行、中国银行位列前四，中国石油、中国移动、中国石化、中国平安、中国建筑和招商银行进入前十。",
    "publishedAt": "2026-08-02",
    "source": "钛媒体",
    "tags": [
      "china",
  ...
  {
    "id": "news-ai-1785664030000",
    "title": " 他带着AI 去打官司，结果让对面躺赢了 ",
    "link": "https://www.huxiu.com/article/4880056.html?f=rss",
    "summary": "本文来自微信公众号： APPSO ，作者：发现明日产品的，原文标题：《他带着 AI 去打官司，结果让对面躺赢了》 「我明天要见心理咨询师，」一位居住在波士顿的年轻妈妈，正在规划第二天的行程，不过，这话她既不是说给丈夫听的，也不是说给孩子听的，而是说给Claude听的。「帮我捋一捋上次咨询之后我们聊过什么，有什么该拿出来说的。」 Claude一键跟随，把她最近的工作压力、跟伴侣的摩擦，整合关联到了一段反复出现的情绪主题，「觉得自己不被看见、不被听见」，整理完成，她明天将带着Claude一起走进诊疗室。 她管这叫帮自己拼起咨询间隙里那些闪念，因此她很信任AI，「它很擅长把你的想法用一种写得很好的方式反射回来，让你更理解自己，也许也更理解身边的人。」 这位年轻妈妈并不是孤例。根据KFF的民调，16%的美国成年人在过去一年里使用过AI工具处理心理健康问题，年轻人比例更高。Pew的数据显示三分之二的美国青少年跟聊天机器人有互动，28%每天都在聊。 APA在2026年对1200多名持证心理医生的调查给出了一个让人停下来的数字：超过三分之一的受访者报告，他们的病人正在把AI当作「额外的心理医生」来用。 在过去AI普及的几年间，这已经逐渐成为常态。尽管一时之间，AI还不能完全取代心理咨询，但作为辅助，它正在变得不可或缺——不仅是对病人而言，也是对医生而言。 波士顿的一位精神科医生，给记者演示了她怎",
    "publishedAt": "2026-08-02",
    "source": "虎嗅",
    "tags": [
      "china",
  ...
  {
    "id": "news-7-31-1785644513000",
    "title": "价值判断：涨停板的投资机会和风险提示（7月31日）｜上市公司观察",
    "link": "https://www.tmtpost.com/8088406.html",
    "summary": "行业板块呈现普涨态势，广告营销、机器人、IT服务、软件开发、影视院线、传媒、计算机设备、元件、半导体板块涨幅居前，仅银行、保险、能源金属板块逆市下跌。个股方面，上涨股票数量接近4700只，逾百股涨停。",
    "publishedAt": "2026-08-02",
    "source": "钛媒体",
    "tags": [
      "china",
...
export const generatedPapers: ArxivPaper[] = [
  ...
  },
  {
    ...
    "link": "http://arxiv.org/abs/2607.28627v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "cs.CV",
      "cs.AI",
  ...
  },
  {
    ...
    "summary": "Chemistry literature synthesis often requires assembling specific findings scattered across many publications, yet existing literature-search systems primarily return ranked document lists. As a result, scientists and AI agents need to locate relevant information, verify their provenance, and assemble cross-paper answers manually. We present AskChem, a claim-centered infrastructure for cross-paper chemistry search. AskChem changes the unit of retrieval from the paper to the provenance-carrying claim: each paper is converted into atomic, typed claims, each grounded by a source DOI and a verbatim quote or an explicit evidence locator. Over this shared claim store, AskChem exposes complementary structures for search and synthesis: a stabilized faceted taxonomy for hierarchical retrieval and b",
  ...
  },
  {
    ...
    "summary": "Clinical risk models routinely achieve strong aggregate performance while producing materially different error rates across patient subgroups. Audit pipelines have been proposed to catch this, but their components are rarely stress-tested, so it is unclear which parts of an audit can be trusted and under what conditions. We present KAISEN, a five-phase audit pipeline covering subgroup stratification, disparity measurement, mechanism diagnostics, post-hoc mitigation, and drift monitoring, evaluated to the point of failure on a synthetic benchmark of 16 disease tasks, 15 social-determinant axes from Healthy People 2030, and three prespecified intersections. Four findings follow. (i) Significance tracks each axis's gap against its own minimum detectable effect: rank correlation between signif",
  ...
  },
  {
    ...
    "summary": "Scaling coding agents requires a continuing supply of executable data for training, benchmarking, and continuous evaluation. Each task must couple a realistic software state with a specification, development tools, and reliable verification. To expand this supply, we present Change2Task, a system grounded in repository history that converts merged pull requests into verified tasks on healthy modern revisions of the same repository. It aligns historical evidence with evolved code, reconstructs task states through Patch Reversal, Code Mapping, or Agent Reconstruction, and validates the lifecycle from a healthy base to a task state and a restored state. By deriving multiple tasks grounded in developer evidence from maintained environments, Change2Task provides executable data for coding agent",
    "link": "http://arxiv.org/abs/2607.28591v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "cs.SE",
      "cs.CL",
  ...
  {
    "id": "arxiv-2607.28575v1",
    "title": "Algorithms for Structured Elections under Thiele Voting Rules",
    "authors": [
      "Alexandra Lassota",
      "Krzysztof Sornat"
    ],
    "summary": "We study the computational complexity of winner determination problems in approval-based committee elections under Thiele voting rules. These form a class of rules parameterized by a fixed weight vector that specifies how a voter's satisfaction depends on the number of approved candidates elected. We first analyze the structure of optimal solutions based on the sets of voters who approve each candidate---that is, how voters' approval ballots induce dependencies between candidates---revealing constraints on a winning committee under any fixed Thiele voting rule. Using this, we design FPT algorithms for Proportional Approval Voting (PAV) and other Thiele rules on a natural restricted domain known as the Voter Interval (VI) domain---that is, after a suitable ordering of voters, each candidate",
    "link": "http://arxiv.org/abs/2607.28575v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "cs.GT",
      "cs.AI",
  ...
  },
  {
    ...
    "link": "http://arxiv.org/abs/2607.28573v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "cs.AI"
    ]
  ...
  },
  {
    ...
    "link": "http://arxiv.org/abs/2607.28567v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "stat.ML",
      "cs.LG",
  ...
  },
  {
    ...
    "link": "http://arxiv.org/abs/2607.28553v1",
    "publishedAt": "2026-07-30",
    "categories": [
      "cs.LG",
      "cs.AI",
...
export const dataFetchedAt = '2026-08-02T11:13:52.773Z';
