...
export const generatedNews: NewsItem[] = [
  ...
  {
    "id": "news-nike-8217-s-7-5-million-pay-bias-verdict-a-warning-to-hr-1785155451000",
  ...
  },
  {
    ...
    "summary": "Accenture’s Marta Lajmi argues the Western playbook for AI adoption – access, training, incentives – does not translate to a region where employees wait for leaders to make change feel safe. The post Why Western AI adoption strategies may fall short in Southeast Asia appeared first on HR Executive .",
    "publishedAt": "2026-07-27",
    "source": "HR Executive",
    "tags": [
      "hr",
